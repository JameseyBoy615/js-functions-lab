...
const generateEmail = (name = "Username", domain = "example.com") => {
  return `${name}@${domain}`;
};
...
const convertTemperature = (temperature, scale) => {
  if (scale === "F") {
    ...
    return celsius.toFixed(1) + " Celsius";
  } else if (scale === "C") {
    const fahrenheit = (temperature * 9) / 5 + 32;
    return fahrenheit.toFixed(1) + " Fahrenheit";
  } else {
...
const basicCalculator = (numA, numB, operation) => {
  switch (operation) {
    ...
    case "divide":
      ...
      break;
    default:
      return "please enter two valid numbers and an operation";
  }
};
...
const createUsername = (firstName, lastName) => {
  ...
  return firstName.slice(0, 3) + lastName.slice(0, 3) + letters;
};
